...
VALUES
  ('Alice Johnson', 101, '2000-05-12', 1001, 'CSE', 'A', 2024, 2021,
   'Robert Johnson', 'Engineer', 'Teacher', 'Middle class', 234567890,
   '123 Main St, Cityville', 'English, Spanish', 'Mary Johnson', 'High School A', 'English',
   85, 90, 88, 87, 'General', 'Dr. Smith', 'Ms. Parker', 'Mr. Lee', 'Mrs. Davis', NOW(), NOW()),
